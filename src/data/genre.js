// Exporting a constant named 'genreData' (used for anime genre information)
export const genreData = {
  // An object with a property named 'data', which contains an array of genre entries
  data: [
    {
      // Genre information for the first entry
      mal_id: 1, // MyAnimeList genre ID
      name: "Action", // Name of the genre (in this case, "Action")
      url: "https://myanimelist.net/anime/genre/1/Action", // URL to the genre's MyAnimeList page
      count: 4785, // Number of anime titles categorized under this genre
    },
    // (Additional genre entries with similar information)
    {
      mal_id: 2,
      name: "Adventure",
